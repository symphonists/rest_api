...
Class REST_Sections {
	...
	// fields that cause errors when appendFormattedElement is called out of context!
	...
	public function run() {
		...
		// resolve section ID if in the URL
		...
		if (!reset($sections) instanceOf Section) REST_API::renderError('Section not found.');
